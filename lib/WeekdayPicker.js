...
var _reactDayPickerUtils = require("react-day-picker/utils");
...
var WeekdayPicker = (function (_Component) {
  ...
  _createClass(WeekdayPicker, [{
    ...
    value: function getModifiersForDay(d, modifierFunctions) {
      var modifiers = [];
    ...
    value: {
      tabIndex: 0,
      locale: "en",
      localeUtils: _reactDayPickerUtils.localeUtils,
